...
class condGANTrainer(object):
    ...
    def build_models(self, gpu):
        ...
        pretrained_path = os.path.join(cfg.TRAIN.NET_E.split('/')[0], 'inception_v3_google-1a9a5a14.pth')
        image_encoder = CNN_ENCODER(cfg.TEXT.EMBEDDING_DIM, pretrained_path=pretrained_path)
